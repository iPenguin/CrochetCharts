...
FileLoad_v1::FileLoad_v1(FileFactory *parent)
    : File(parent)
{

}

FileFactory::FileError FileLoad_v1::load(QXmlStreamReader *stream)
{
...
void FileLoad_v1::loadColors(QXmlStreamReader* stream)
{
...
void FileLoad_v1::loadChart(QXmlStreamReader* stream)
{
    MainWindow* mw = qobject_cast<MainWindow*>(mParent->mParent);
    CrochetTab* tab = 0;
...
void FileLoad_v1::loadGrid(QXmlStreamReader* stream, Scene* scene)
{
...
void FileLoad_v1::loadIndicator(CrochetTab* tab, QXmlStreamReader* stream)
{
...
void FileLoad_v1::loadCell(CrochetTab* tab, QXmlStreamReader* stream)
{
