...
Stitch* StitchLibrary::findStitch(QString uid)
{
    return mMasterSet->findStitch(uid);
}

Stitch* StitchLibrary::findStitchByName(QString name)
{
    return mMasterSet->findStitchByName(name);
}
